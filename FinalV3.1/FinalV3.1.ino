...
#define DirZ 10 //pino direção Z (PINO 5 DEIXOU DE FUNCIONAR)
...
void IncPos() {
  ...
  if (datareceived == true) {
    ...
    if (FINALPOSY[inc] != Yaxis.currentPosition() || FINALPOSZ[inc] != Zaxis.currentPosition()) {
      for (int i = 1; i <= (inc); i++) {
